...
const TGT = "!w-3 !h-3 !bg-cyan-700 !border-2 !border-zinc-900 hover:!bg-cyan-400 !rounded-full transition-colors";
const SRC = "!w-3 !h-3 !bg-cyan-500 !border-2 !border-zinc-900 hover:!bg-cyan-300 !rounded-full transition-colors";
