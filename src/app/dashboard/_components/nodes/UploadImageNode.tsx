...
const SRC = "!w-3 !h-3 !bg-blue-400 !border-0 hover:!scale-125 !rounded-full transition-transform";
...
export function UploadImageNode({ id, data, selected }: NodeProps<UploadImageNodeType>) {
  ...
  const border = status !== NodeStatus.Idle
    ...
    : selected
      ? "border-blue-400/70 shadow-[0_0_0_1px_rgba(96,165,250,0.15)]"
      : "border-white/[0.07]";
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute -top-6 left-0 flex items-center gap-1.5 pointer-events-none select-none">
        ...
        <span className="text-[11px] text-[#888] font-book">Image</span>
      ...
      <div className={`bg-[#1c1c1c] rounded-2xl border transition-all min-w-[240px] ${border}`}>
        ...
        <div className="p-3 flex flex-col gap-2">
          ...
          {data.previewUrl ? (
            <div className="relative">
              <img src={data.previewUrl} alt="preview" className="w-full rounded-xl object-cover max-h-40" />
